...
export default function Home() {
  return (
    <Container>
      ...
      <Paragraph className="max-w-4xl mt-4">
        I&apos;ve worked on a wide range of projects — from cloud-based note-taking apps and blog management systems to branding websites and Python-based tools like a YouTube video downloader. Whether it&apos;s implementing authentication, integrating rich text editors or handling image uploads. I enjoy tackling challenges with code and creativity.
      </Paragraph>
      <Paragraph className="max-w-4xl mt-4">
        I specialize in ReactJS, TailwindCSS, Node.js, Express, and MongoDB, and I&apos;m always experimenting with tools like Clerk, Redux, and Google OAuth to stay ahead. Beyond just writing code, I focus on building reusable components, pixel-perfect UIs, and scalable architecture.

        I thrive in environments where I can continuously learn, push my limits, and contribute to meaningful user experiences.
      </Paragraph>

      <Paragraph className="max-w-4xl mt-4">
        I&apos;m a fresher frontend developer building scalable web apps
